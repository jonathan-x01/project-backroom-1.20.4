...
import projectbackroom.jonathanx.rendering.entities.ModdedAnimations;
...
public class FacelingModel<T extends FacelingEntity> extends SinglePartEntityModel<T> {
	...
	public void setAngles(FacelingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateMovement(ModdedAnimations.FACELING_WALK, limbSwing, limbSwingAmount, 2f, 5.5f);
		this.updateAnimation(FacelingEntity.idleAnimationState, ModdedAnimations.FACELING_IDLE, ageInTicks,2f);
	}
